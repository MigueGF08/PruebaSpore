  ...
  <div class="MisCarros">
    ...
    <nav class="navbar">
      <ul>
        ...
        <li v-if="isAdmin">
          <router-link to="/carros-registrados" class="nav-link">Carros Registrados</router-link>
        </li>
        <li v-if="isAdmin">
          <router-link to="/usuarios-registrados" class="nav-link">Usuarios</router-link>
        </li>
        <li v-if="isAdmin || isUser">
